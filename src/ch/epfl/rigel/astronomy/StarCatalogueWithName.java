...
public final class StarCatalogueWithName {

    private final Map<AsterismWithName, List<List<Integer>>> asterismsMap;
     ...
     */
    public StarCatalogueWithName(List<Star> stars, List<AsterismWithName> asterisms) {

        this.stars = List.copyOf(stars);

        HashMap<AsterismWithName, List<List<Integer>>> aMap = new HashMap<>();
        ...
        for (AsterismWithName a : asterisms) {
            List<List<Integer>> starsList = new ArrayList<>(a.stars().size());

            for (List<Star> sList : a.stars()) {
                ...
                starsList.add(aIndex);

            }
            aMap.put(a, Collections.unmodifiableList(starsList));
        }
    ...
    public Set<AsterismWithName> asterisms() {
    ...
    public final static class Builder {
        ...
        private final List<AsterismWithName> asterisms = new ArrayList<>();
         ...
         * @return le bâtisseur
         */
        public Builder addAsterism(AsterismWithName asterism) {
         ...
         */
        public List<AsterismWithName> asterisms() {
         ...
         */
        public StarCatalogueWithName build() {
            return new StarCatalogueWithName(stars, asterisms);
        }
    }
